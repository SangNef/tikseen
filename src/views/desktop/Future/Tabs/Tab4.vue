<template>
    <div class="filter-order flex items-center gap-3 flex-wrap py-3">
        ...
        <span class="text-[#515c70] font-semibold text-xs">Kiểu</span>
...
<style>
.filter-order .ant-select .ant-select-selector {
...
.filter-order .ant-picker-separator,
.filter-order .ant-picker-separator svg,
.filter-order .ant-picker .ant-picker-suffix svg,
.filter-order .ant-picker .ant-picker-clear svg {
    color: #464f5f !important;
    fill: #464f5f !important;
...
.ant-picker-cell-inner {
    background: rgb(28, 32, 42) !important;
}
