        ...
        <div v-if="showTagModal" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50">
            <div class="bg-white rounded-xl shadow-xl p-6 w-96 relative">
                ...
                <div class="flex w-full gap-2 flex-nowrap mb-4">
                    <input type="text" placeholder="Enter new tag" class="border border-gray-300 w-full rounded-lg px-3 py-1 outline-none">
                    <button class="bg-blue-500 px-3 rounded-lg text-white hover:bg-blue-600 duration-300" @click="handleAddTag">Add</button>
                </div>
