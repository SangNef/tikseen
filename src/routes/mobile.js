...
import { Login } from '@/views/mobile/Auth';
import { Earn, Envelope, Event, EventDetail, Exchange, Home, Invite, Partner, Vip } from '@/views/mobile/Home';
...
import InviteReward from '@/views/mobile/Home/InviteReward.vue';
