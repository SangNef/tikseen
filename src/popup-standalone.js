// LiveChat Widget standalone version
// This file is compiled to a standalone script that doesn't use ES modules
...
class LiveChatWidget {
  ...
  init() {
    ...
    // Thông báo rằng cấu hình đã được khởi tạo
    console.log('LiveChat Widget đã được khởi tạo với cấu hình:', this.config);

    // Trong phiên bản standalone này, chúng ta chỉ khởi tạo cấu hình
    // Phần Vue app sẽ được tải độc lập từ vippromax-livechat/main.js
